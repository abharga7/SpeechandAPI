...
public class MainActivity extends AppCompatActivity implements SpeechDelegate {
    ...
    public  void onSpeechResult(String result) {
        ...
        //this gets the speech result.
        //pass this to the async task method along with the query.
        //I have commeneted outthe code currently
        //uncomment this line of code to see if its works
        String URL = "http://ec2-54-208-79-9.compute-1.amazonaws.com:8080/hello-world";
        new CallAPI().execute(URL,result);
    ...
    public class CallAPI extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                postDataParams.put("content", params[1]);
        ...
        protected void onPostExecute(String result){
            ...
            try {
                ...
                textResult.setText(resultobj.get("content").toString());
                //onSpeakClick();//textToSpeech.setText();
                Speech.getInstance().say(resultobj.get("content").toString());
